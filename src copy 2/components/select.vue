<template>
  <div class="divInput"  @mouseleave="mouseLeave">
    <div class="input" @click="openValue">
      ...
      <input type="text" :placeholder="cardName?cardName:value" ref="inputText">
      <!-- <input type="text" :placeholder="value"> -->
      <img src="../assets/arrow.png" alt="">
    </div>
    <div class="list" v-show="show">
      <!-- <div @click="getvalue(index,item)" v-for="(item,index) in (cardArr.length > 0 ? cardArr : cardList)" :key="item.id"> -->
...
import {mapState} from 'vuex'
  export default {
    ...
    mounted() {
      ...
      this.cardList.unshift({'name':'无卡卷','id':''})
    },
    computed:{
      ...mapState({
    ...
    methods: {
      ...
      getvalue(index,item){
        ...
        console.log(this.$refs.inputText.placeholder);
        this.$refs.inputText.placeholder = item.name
        this.show=false;
